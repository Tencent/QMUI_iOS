 ...
 *  所以，这里把needsTakeOverTouchEvent设置为yes，则会通过重写touch事件来模拟系统的延迟效果，但是同时又比较优雅的处理setHighlighted的问题
 *  @warning 不需要搭配 UIScrollView.delaysContentTouches 使用。
 */
@property(nonatomic,assign,readwrite) BOOL needsTakeOverTouchEvent;
/*
