...
/**
 允许当前 window 接管 statusBar 的样式设置，默认为 YES。这个属性只对 iOS 10 及以后生效，8、9 遇到这种情况下暂时没有办法。
